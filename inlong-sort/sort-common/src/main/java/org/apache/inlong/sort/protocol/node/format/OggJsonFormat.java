...
@JsonTypeName("oggJsonFormat")
@Data
public class OggJsonFormat implements Format {

    private static final long serialVersionUID = 1L;

    private static final String IDENTIFIER = "ogg-json";
    ...
    @JsonProperty(value = "mapNullKeyMode", defaultValue = "FAIL")
    ...
    public OggJsonFormat(
            ...
            @JsonProperty(value = "mapNullKeyMode", defaultValue = "FAIL") String mapNullKeyMode,
    ...
    @JsonCreator
    public OggJsonFormat() {
        this(false, "SQL", "FAIL", "null", true);
    }

    /**
     * return format ogg-json
     *
     * @return format
     */
    @Override
    ...
    /**
     * Return the identifier of this format ogg-json
     *
     * @return The identifier of this format ogg-json
     */
    @Override
    ...
    public Map<String, String> generateOptions() {
        ...
        if (this.ignoreParseErrors != null) {
            options.put("ogg-json.ignore-parse-errors", this.ignoreParseErrors.toString());
        }
        options.put("ogg-json.timestamp-format.standard", this.timestampFormatStandard);
        options.put("ogg-json.map-null-key.mode", this.mapNullKeyMode);
        options.put("ogg-json.map-null-key.literal", this.mapNullKeyLiteral);
        if (this.encodeDecimalAsPlainNumber != null) {
            options.put("ogg-json.encode.decimal-as-plain-number", this.encodeDecimalAsPlainNumber.toString());
        }
        return options;
    }
}
