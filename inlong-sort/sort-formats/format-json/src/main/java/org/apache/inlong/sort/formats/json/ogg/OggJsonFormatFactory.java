...
import org.apache.inlong.sort.formats.json.JsonOptionsUtil;
...
import static org.apache.inlong.sort.formats.json.ogg.OggJsonOptions.IGNORE_PARSE_ERRORS;
import static org.apache.inlong.sort.formats.json.ogg.OggJsonOptions.JSON_MAP_NULL_KEY_LITERAL;
import static org.apache.inlong.sort.formats.json.ogg.OggJsonOptions.JSON_MAP_NULL_KEY_MODE;
import static org.apache.inlong.sort.formats.json.ogg.OggJsonOptions.TIMESTAMP_FORMAT;
...
public class OggJsonFormatFactory
    ...
    private static void validateDecodingFormatOptions(ReadableConfig tableOptions) {
        JsonOptionsUtil.validateDecodingFormatOptions(tableOptions);
    }

    /** Validator for ogg encoding format. */
    private static void validateEncodingFormatOptions(ReadableConfig tableOptions) {
        JsonOptionsUtil.validateEncodingFormatOptions(tableOptions);
    }
    ...
    public DecodingFormat<DeserializationSchema<RowData>> createDecodingFormat(
        ...
        final TimestampFormat timestampFormat =
                JsonOptionsUtil.getTimestampFormat(formatOptions);
    ...
    public EncodingFormat<SerializationSchema<RowData>> createEncodingFormat(
        ...
        TimestampFormat timestampFormat = JsonOptionsUtil.getTimestampFormat(formatOptions);
        JsonOptions.MapNullKeyMode mapNullKeyMode =
                JsonOptionsUtil.getMapNullKeyMode(formatOptions);
