...
public class JdbcSourceEventDispatcher extends EventDispatcher<TableId> {
    ...
    protected final HistorizedDatabaseSchema historizedSchema;
    protected final DataCollectionFilters.DataCollectionFilter<TableId> filter;
    protected final CommonConnectorConfig connectorConfig;
    protected final TopicSelector<TableId> topicSelector;
    protected final Schema schemaChangeKeySchema;
    protected final Schema schemaChangeValueSchema;
