...
import org.apache.inlong.sort.cdc.oracle.dialect.DataSourceDialect;
import org.apache.inlong.sort.cdc.oracle.source.assigner.HybridSplitAssigner;
import org.apache.inlong.sort.cdc.oracle.source.assigner.SplitAssigner;
import org.apache.inlong.sort.cdc.oracle.source.assigner.StreamSplitAssigner;
import org.apache.inlong.sort.cdc.oracle.source.assigner.state.HybridPendingSplitsState;
import org.apache.inlong.sort.cdc.oracle.source.assigner.state.PendingSplitsState;
import org.apache.inlong.sort.cdc.oracle.source.assigner.state.PendingSplitsStateSerializer;
import org.apache.inlong.sort.cdc.oracle.source.assigner.state.StreamPendingSplitsState;
import org.apache.inlong.sort.cdc.oracle.source.config.MetricConfig;
import org.apache.inlong.sort.cdc.oracle.source.enumerator.IncrementalSourceEnumerator;
import org.apache.inlong.sort.cdc.oracle.source.meta.split.SourceSplitBase;
import org.apache.inlong.sort.cdc.oracle.source.meta.split.SourceSplitSerializer;
...
import org.apache.inlong.sort.cdc.oracle.source.reader.IncrementalSourceReader;
import org.apache.inlong.sort.cdc.oracle.source.reader.IncrementalSourceRecordEmitter;
import org.apache.inlong.sort.cdc.oracle.source.reader.IncrementalSourceSplitReader;
