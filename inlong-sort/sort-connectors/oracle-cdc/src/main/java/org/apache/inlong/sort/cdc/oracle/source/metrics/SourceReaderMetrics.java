...
package org.apache.inlong.sort.cdc.oracle.source.metrics;
...
public class SourceReaderMetrics {
    ...
    /**
     * The last record processing time, which is updated after {@link SourceReaderMetrics} fetches a
    ...
    public void outputMetrics(String database, String schema, String table, boolean isSnapshotRecord, Object data) {
        if (sourceTableMetricData != null) {
            sourceTableMetricData.outputMetricsWithEstimate(database, schema, table, isSnapshotRecord, data);
        }
    }
