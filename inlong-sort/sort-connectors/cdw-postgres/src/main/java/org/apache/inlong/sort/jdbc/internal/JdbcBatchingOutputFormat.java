...
public class JdbcBatchingOutputFormat<In, JdbcIn, JdbcExec extends JdbcBatchStatementExecutor<JdbcIn>>
    ...
    private JdbcExec createAndOpenStatementExecutor(
        ...
        try {
            Field jdbcOptionsField = SimpleJdbcConnectionProvider.class.getDeclaredField("jdbcOptions");
            // Make the field accessible
            jdbcOptionsField.setAccessible(true);
            // Retrieve the value of the field for the specific SimpleJdbcConnectionProvider instance
            JdbcConnectionOptions options = (JdbcConnectionOptions) jdbcOptionsField.get(connectionProvider);
