...
package org.apache.inlong.sort.cdc.sqlserver.base.util;
...
public class RecordUtils {
    ...
    public static final String SQLSERVER_SCHEMA_CHANGE_EVENT_KEY_NAME = "io.debezium.connector.sqlserver"
            + ".SchemaChangeKey";
    ...
    public static boolean isSchemaChangeEvent(SourceRecord sourceRecord) {
        ...
        return keySchema != null && (MYSQL_SCHEMA_CHANGE_EVENT_KEY_NAME.equalsIgnoreCase(keySchema.name())
                ...
                || SQLSERVER_SCHEMA_CHANGE_EVENT_KEY_NAME.equalsIgnoreCase(keySchema.name()));
    }
