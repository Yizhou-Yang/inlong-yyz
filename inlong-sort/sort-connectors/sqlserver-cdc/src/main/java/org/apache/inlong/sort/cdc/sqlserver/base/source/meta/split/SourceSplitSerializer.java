...
package org.apache.inlong.sort.cdc.sqlserver.base.source.meta.split;
...
import org.apache.inlong.sort.cdc.sqlserver.base.source.metrics.TableMetric;
 ...
 * Copy from com.ververica:flink-cdc-base:2.4.0.
 * */
public abstract class SourceSplitSerializer
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SourceSplitSerializer.class);
    ...
    public byte[] serialize(SourceSplitBase split) throws IOException {
        if (split.isSnapshotSplit()) {
            ...
            try {
                Field field = SnapshotSplit.class.getDeclaredField("serializedFormCache");
                field.setAccessible(true);
                if (field.get(snapshotSplit) != null) {
                    return (byte[]) field.get(snapshotSplit);
                }
            } catch (NoSuchFieldException | IllegalAccessException e) {
                LOG.warn("get serializedFormCache exception", e);
            }
            ...
            try {
                Field field = SnapshotSplit.class.getDeclaredField("serializedFormCache");
                field.setAccessible(true);
                field.set(snapshotSplit, result);
            } catch (NoSuchFieldException | IllegalAccessException e) {
                LOG.warn("get serializedFormCache exception", e);
            }
            return result;
            ...
            // optimization: the splits lazily cache their own serialized form
            try {
                Field field = StreamSplit.class.getDeclaredField("serializedFormCache");
                field.setAccessible(true);
                if (field.get(streamSplit) != null) {
                    return (byte[]) field.get(streamSplit);
                }
            } catch (NoSuchFieldException | IllegalAccessException e) {
                LOG.warn("get serializedFormCache exception", e);
            }
