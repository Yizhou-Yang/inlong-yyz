...
package org.apache.inlong.sort.cdc.sqlserver.source.reader.fetch;
...
import org.apache.inlong.sort.cdc.sqlserver.base.relational.JdbcSourceEventDispatcher;
import org.apache.inlong.sort.cdc.sqlserver.base.source.reader.external.JdbcSourceFetchTaskContext;
import org.apache.inlong.sort.cdc.sqlserver.source.config.SqlServerSourceConfig;
import org.apache.inlong.sort.cdc.sqlserver.source.dialect.SqlServerDialect;
import org.apache.inlong.sort.cdc.sqlserver.source.utils.SqlServerUtils;
...
public class SqlServerSourceFetchTaskContext extends JdbcSourceFetchTaskContext {
    ...
    public void configure(SourceSplitBase sourceSplitBase) {
        ...
        final DefaultChangeEventSourceMetricsFactory<SqlServerPartition> changeEventSourceMetricsFactory =
    ...
    private SqlServerOffsetContext loadStartingOffsetState(
            Loader loader, SourceSplitBase sourceSplitBase) {
        Offset offset =
