...
package org.apache.inlong.sort.cdc.sqlserver.source;
...
import org.apache.inlong.sort.cdc.sqlserver.source.reader.SqlSeverRecordEmitter;
...
public class SqlServerSourceBuilder<T> {
    ...
    public SqlServerSourceBuilder<T> inlongMetric(String inlongMetric) {
        this.configFactory.inlongMetric(inlongMetric);
        return this;
    }

    public SqlServerSourceBuilder<T> heartbeatInterval(Duration heartbeatInterval) {
        this.configFactory.heartbeatInterval(heartbeatInterval);
        return this;
    }

    public SqlServerSourceBuilder<T> migrateAll(boolean migrateAll) {
    ...
    public static class SqlServerIncrementalSource<T> extends JdbcIncrementalSource<T> {
        ...
        protected RecordEmitter<SourceRecords, T, SourceSplitState> createRecordEmitter(
            ...
            return new SqlSeverRecordEmitter<T>(
