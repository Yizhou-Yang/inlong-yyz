...
package org.apache.inlong.sort.cdc.sqlserver.base.source;
...
import org.apache.inlong.sort.cdc.sqlserver.base.source.assigner.state.PendingSplitsStateSerializer;
import org.apache.inlong.sort.cdc.sqlserver.base.source.meta.split.SourceSplitSerializer;
import org.apache.inlong.sort.cdc.sqlserver.base.source.reader.IncrementalSourceReader;
...
public class IncrementalSource<T, C extends SourceConfig>
    ...
    public IncrementalSourceReader<T, C> createReader(SourceReaderContext readerContext)
        ...
        MetricOption metricOption = MetricOption.builder()
                .withInlongLabels(sqlServerSourceConfig.getInlongMetric())
                .withInlongAudit(sqlServerSourceConfig.getInlongAudit())
                .withRegisterMetric(RegisteredMetric.ALL)
                .build();

        sourceReaderMetrics.registerMetrics(metricOption, sqlServerSourceConfig.getMetricLabelList());
