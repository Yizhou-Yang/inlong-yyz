...
package org.apache.inlong.sort.cdc.sqlserver.base.source.assigner.state;
...
import org.apache.inlong.sort.cdc.sqlserver.base.source.meta.split.SourceSplitSerializer;
...
import static org.apache.inlong.sort.cdc.sqlserver.base.source.meta.split.SourceSplitSerializer.readTableSchemas;
import static org.apache.inlong.sort.cdc.sqlserver.base.source.meta.split.SourceSplitSerializer.writeTableSchemas;
...
public class PendingSplitsStateSerializer implements SimpleVersionedSerializer<PendingSplitsState> {
    ...
    public byte[] serialize(PendingSplitsState state) throws IOException {
        ...
        try {
            Field field = PendingSplitsState.class.getDeclaredField("serializedFormCache");
