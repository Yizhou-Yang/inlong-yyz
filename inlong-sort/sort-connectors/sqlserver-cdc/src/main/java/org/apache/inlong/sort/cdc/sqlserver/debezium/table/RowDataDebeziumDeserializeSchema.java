...
package org.apache.inlong.sort.cdc.sqlserver.debezium.table;
...
import org.apache.inlong.sort.cdc.sqlserver.base.util.RecordUtils;
import org.apache.inlong.sort.cdc.sqlserver.base.util.TemporalConversions;
...
public final class RowDataDebeziumDeserializeSchema
    ...
    private Object getValueWithSchema(Object fieldValue, String schemaName) {
        ...
        if (schemaName.endsWith(MicroTime.SCHEMA_NAME)) {
            ...
            Instant instantTime = Instant.ofEpochMilli((Long) fieldValue / 1000_000);
            fieldValue = LocalDateTime.ofInstant(instantTime, ZONE_UTC).toString();
            ...
            Instant instant = Instant.ofEpochMilli((Long) fieldValue / 1000_000);
            fieldValue = timeFormatter.format(LocalDateTime.ofInstant(instant, ZONE_UTC));
        }
        return fieldValue;
    }
