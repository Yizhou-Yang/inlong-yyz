    ...
    protected void checkSplitOrStartNext() throws IOException {
        ...
        if (canAssignNextSplit()) {
            ...
            if (nextSplit.isSnapshotSplit()) {
                LOG.info("lk_test, in checkSplitOrStartNext isSnapshotSplit, subtaskId:{}", subtaskId);
                if (currentFetcher == null) {
                    LOG.info("lk_test, in checkSplitOrStartNext isSnapshotSplit, dataSourceDialect:{}",
                            dataSourceDialect);
                    ...
                    LOG.info("lk_test, in checkSplitOrStartNext currentFetcher is null, subtaskId:{}", subtaskId);
                } else {
                    LOG.info("lk_test, in checkSplitOrStartNext currentFetcher is not null, subtaskId:{}", subtaskId);
                }
            } else {
                LOG.info("lk_test, in checkSplitOrStartNext isStreamSplit, subtaskId:{}", subtaskId);
                LOG.info("lk_test, in checkSplitOrStartNext isStreamSplit, dataSourceDialect:{}", dataSourceDialect);
