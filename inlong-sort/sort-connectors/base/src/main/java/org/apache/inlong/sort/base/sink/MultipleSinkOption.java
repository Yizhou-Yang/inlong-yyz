...
public class MultipleSinkOption implements Serializable {
    ...
    public MultipleSinkOption(String format,
            ...
            String tablePattern,
            boolean pkAutoGenerated, String sinkPartitionRules) {
        this.format = format;
    ...
    public static class Builder {
        ...
        private String sinkPartitionRules;
        ...
        public MultipleSinkOption.Builder withSinkPartitionRules(String sinkPartitionRules) {
            this.sinkPartitionRules = sinkPartitionRules;
            return this;
        }
